...
<section>
    ...
    <form method="get" action="meals/filter">
        ...
        <button type="submit"><spring:message code="filter.button"/></button>
    </form>
    <hr/>
    ...
    <table border="1" cellpadding="8" cellspacing="0">
        <thead>
        <tr>
            <th><spring:message code="meal.field.date"/></th>
            <th><spring:message code="meal.field.description"/></th>
            <th><spring:message code="meal.field.calories"/></th>
            <th></th>
            <th></th>
        </tr>
        </thead>
        <c:forEach items="${requestScope.meals}" var="meal">
            ...
            <tr data-meal-excess="${meal.excess}">
                ...
                <td>${meal.calories}</td>
                <td><a href="meals/update?id=${meal.id}" methods=""><spring:message
